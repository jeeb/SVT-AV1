...
#define FIX_INVALID_PTR_AFTER_REALLOC         0 // Fix invalid pointer after realloc from AOMediaCodec/SVT-AV1!1737
#define FIX_INVALID_PTR_AFTER_REALLOC_2       1 // Fix invalid pointer after realloc from AOMediaCodec/SVT-AV1!1745
...
#define FIX_EC_OVERFLOW                       1 // Make bitstream buffers adaptive to avoid overflow
#define TUNE_PRESETS_DECODER                  1 // Tune MFMV/CDEF/Restoration for decoder speed up
